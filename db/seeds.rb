...
results = results.map do |result| 
  result.sub("Serie manga - ", "").strip.downcase
end

url = html_doc.search('.searchCat .resManga a')[results.index(serie_name.downcase)].attribute('href').value
...
10.times do |i|
  ...
  title = html_doc.xpath('//a[starts-with(@class, "entryTlink")]').children[0].text.delete("\n").strip
